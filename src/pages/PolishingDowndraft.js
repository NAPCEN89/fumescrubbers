...
import polishingDowndraftImage from '../assets/images/products/Downdraft tbale/Polishing-downdraft-table.jpg';
...
const PolishingDowndraftTable = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Polishing Downdraft Table Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Explore NAPCEN's Polishing Downdraft Tables, designed to effectively capture fine dust and fumes from polishing and buffing, ensuring a clean and safe workspace."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={polishingDowndraftImage}
                  alt="Polishing Downdraft Table"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '700px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Polishing Downdraft Table is designed to effectively capture fine dust and fumes generated during polishing and buffing operations, ensuring a clean and safe workspace for operators.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
                  ...
                  >
                    {[
                      'High-efficiency filtration for fine polishing dust',
                      'Quiet operation for comfortable working environment',
                      'Ergonomic design for operator comfort',
                      'Durable, scratch-resistant tabletop surface',
                    ].map((item, index) => (
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  Fine dust particles generated during polishing are drawn downward through the perforated tabletop into a high-efficiency filtration system, capturing contaminants and releasing clean air back into the workspace.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
                      ...
                      <Grid item xs={12} sm={7}>
                        <Box sx={{ pl: { xs: 0, sm: 2 }, pt: { xs: 1, sm: 0 } }}>
                          {activeTab === 0 && (
                            ...
                            >
                              {[
                                'Jewelry manufacturing for fine polishing dust control',
                                'Automotive finishing operations for surface preparation',
                                'Medical device laboratories for precision polishing',
                                'Woodworking for surface finishing applications',
                                'Composite materials finishing for aerospace and automotive',
                              ].map((item, index) => (
                                <ListItem key={index} disableGutters>
                                  <Typography
                                    variant="body1"
                          ...
                          {activeTab === 1 && (
                            ...
                            >
                              {[
                                ...
                                'High-efficiency HEPA filtration media',
                                'Corrosion-resistant powder-coated finish',
                                'Perforated stainless steel work surface',
                                'Reinforced frame for heavy workpiece support',
                              ].map((item, index) => (
                                <ListItem key={index} disableGutters>
                                  <Typography
                                    variant="body1"
                          ...
                          {activeTab === 2 && (
                            ...
                            >
                              {[
                                'Dust collection drawers for easy cleanup',
                                'Variable speed polishing motors',
                                'Integrated lighting for precision work',
                                'Adjustable work surface height',
                                'Spark arrestor screens for safety',
                              ].map((item, index) => (
                                <ListItem key={index} disableGutters>
                                  <Typography
                                    variant="body1"
                          ...
                          {activeTab === 3 && (
                            ...
                            >
                              {[
                                'Filtration efficiency up to 99.97% for 0.3 micron particles',
                                'Airflow capacity up to 1500 CFM for heavy polishing',
                                'Low noise levels under 70 dB for operator comfort',
                                'Energy-efficient EC motor technology',
                                'Quick-change filter system for minimal downtime',
                              ].map((item, index) => (
                                <ListItem key={index} disableGutters>
                                  <Typography
                                    variant="body1"
      ...
      <DowndraftTable activeLink="/polishing" />
      <CounterSection />
...
export default PolishingDowndraftTable;