...
import DustCollector from '../components/ReusableProducts/DustCollector';
import CounterSection from '../components/sections/CounterSection';
import singleStageDustCollectorImage from '../assets/images/products/dust collector/Single-stage-duct-collector-coimbathur.jpg';
...
const SingleStageDustCollector = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Single Stage Dust Collector Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Explore NAPCEN's Single Stage Dust Collector, designed for efficient dust and particulate removal in industrial applications, ensuring clean air and safety."
        />
      </Helmet>
      ...
      >
        <Container sx={{ px: { xs: 1, sm: 2, md: 3 } }}>
          ...
          >
            ...
            /{' '}
            <RouterLink
              to="/dust-collectors/single-stage"
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={singleStageDustCollectorImage}
                  alt="Single Stage Dust Collector"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '700px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Single Stage Dust Collector efficiently captures dust and particulates, ensuring clean air and safety in industrial and workshop environments.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
                  ...
                  >
                    {[
                      'Efficient filtration for fine dust particles',
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  A powerful fan draws dust-laden air through a high-efficiency filter, trapping particulates and releasing clean air back into the environment.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
                      ...
                      <Grid item xs={12} sm={7}>
                        <Box sx={{ pl: { xs: 0, sm: 2 }, pt: { xs: 1, sm: 0 } }}>
                          {activeTab === 0 && (
                            ...
                            >
                              {[
                                'Woodworking shops for sawdust collection',
                                'Educational workshops for safe environments',
                                'Grinding operations for metal dust control',
                                'Hobbyist workshops for small-scale dust management',
                                'Light industrial applications for particulate removal',
                              ].map((item, index) => (
                                <ListItem key={index} disableGutters>
                                  <Typography
                                    variant="body1"
                          ...
                          {activeTab === 1 && (
                            ...
                            >
                              {[
                                'Durable steel housing for longevity',
                                'High-efficiency filter media',
                                'Reinforced ducting for robust airflow',
                          ...
                          {activeTab === 2 && (
                            ...
                            >
                              {[
                                'Dust collection bags for easy disposal',
                                'Filter cleaning systems for maintenance',
                                'Portable wheels for mobility',
                          ...
                          {activeTab === 3 && (
                            ...
                            >
                              {[
                                ...
                                'Airflow capacity up to 1000 CFM',
      ...
      <DustCollector activeLink="/single-stage" />
      <CounterSection />
...
export default SingleStageDustCollector;