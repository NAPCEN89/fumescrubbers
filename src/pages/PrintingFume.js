...
import printingFumeExtractorImage from '../assets/images/products/Fume extractor/Printing-fume-extractor.jpg';
...
const PrintingFumeExtractor = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Printing Fume Extractor Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Discover NAPCEN's Printing Fume Extractor, a high-efficiency system for capturing VOCs and fumes from printing operations, ensuring safe air quality and compliance."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'400px'}}>
              ...
              >
                <Box
                  component="img"
                  src={printingFumeExtractorImage}
                  alt="Printing Fume Extractor"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'700px'}}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's printing fume extractors capture VOCs and fumes, ensuring clean air.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  Multi-stage filters capture VOCs and particulates from printing processes.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
    ...
    <ResourcesAndQuote/>
      ...
      <FumeExtractor activeLink="/printing" />
      <CounterSection />
...
export default PrintingFumeExtractor;