...
import solderingFumeExtractorImage from '../assets/images/products/Fume extractor/Soldering-fume-Extractor.jpg';
...
const FumeExtractor = React.lazy(() => import('../components/ReusableProducts/FumeExtractor'));
...
const sections = [
  {
    title: 'Applications',
    details: [
      'Electronics assembly and soldering stations',
      'Circuit board repair and rework',
      'Hobbyist soldering workshops',
      'Technical training centers and labs',
  ...
  },
  {
    ...
    details: [
      'Aluminum housing for lightweight durability',
      'Powder-coated steel for corrosion resistance',
      'HEPA filters for fine particle capture',
      'Activated carbon filters for vapor absorption',
      'Heat-resistant extraction arms',
    ],
  },
  {
    title: 'Accessories',
    details: [
      'Adjustable extraction arms for precise positioning',
      'Portable base for easy mobility',
      'Pre-filters for extended filter life',
      'Mounting kits for fixed installations',
  ...
  },
  {
    ...
    details: [
      'High-efficiency fan with 100-1,000 CFM airflow',
      'HEPA filtration up to 99.97% efficiency',
      'Activated carbon filters for VOC removal',
      'Adjustable arm length up to 1.5 meters',
      'Low power consumption for energy efficiency',
    ],
  },
];

const SolderingFumeExtractor = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Soldering Fume Extractor Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Discover NAPCEN's Soldering Fume Extractor, designed to capture hazardous soldering fumes, ensuring safe air quality in electronics manufacturing and repair."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={solderingFumeExtractorImage}
                  alt="Soldering Fume Extractor"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '600px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Soldering Fume Extractor is designed to capture hazardous soldering fumes, ensuring safe air quality in electronics manufacturing, repair, and training environments.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
                  ...
                  <ProductDetailsList
                    items={[
                      'High-efficiency filtration with HEPA and carbon filters',
                      'Adjustable extraction arms for precise fume capture',
                      'Low-noise operation for quiet workspaces',
                      'Portable design for easy repositioning',
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  A high-efficiency fan pulls fume-laden air through HEPA and activated carbon filters, capturing toxic particles and vapors to ensure clean and safe air output.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
     ...
     <ResourcesAndQuote/>
      ...
      <Suspense fallback={<Typography>Loading...</Typography>}>
        <FumeExtractor activeLink="/soldering" />
        <CounterSection />
      </Suspense>
...
export default SolderingFumeExtractor;