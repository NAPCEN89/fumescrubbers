...
import productBrochurePdf from '../assets/document/details/baghouse.pdf'; // Update to specific Glue Vapor Scrubber PDF when available
import glueVaporScrubberImage from '../assets/images/products/Wet scrubber/Glue-Vapor-Scrubber-manufacturer.jpg';
...
const GlueVaporScrubberPage = () => {
  ...
  const sections = [
    {
      title: 'Applications',
      details: [
        'Woodworking industry for adhesive vapor control.',
        'Adhesive manufacturing to capture VOC emissions.',
        'Packaging processes for odor and vapor mitigation.',
        'Automotive assembly for glue-related fume control.',
        'Craft workshops to ensure safe air quality.',
      ],
    },
    {
      title: 'Materials of Construction',
      details: [
        'Polypropylene for chemical resistance to adhesive vapors.',
        'PVC/CPVC for corrosion resistance in humid conditions.',
        'Fiberglass reinforced plastic for lightweight durability.',
        'Stainless steel for robust, long-term performance.',
        'PTFE-lined materials for enhanced chemical compatibility.',
      ],
    },
    {
      title: 'Accessories',
      details: [
        ...
        'High-efficiency packing media for enhanced vapor capture.',
        'pH control systems for neutralizing odorous compounds.',
      ],
    },
  ];
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Glue Vapor Scrubber Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Discover NAPCEN's Glue Vapor Scrubber, designed to capture and neutralize harmful glue vapors and VOCs in industries like woodworking and manufacturing, ensuring compliance and a safer work environment."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={glueVaporScrubberImage}
                  alt="Glue Vapor Scrubber"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '600px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Glue Vapor Scrubber efficiently captures and neutralizes harmful glue vapors, including VOCs, in industries like woodworking and manufacturing, ensuring compliance and a safer work environment.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  Vapor-laden gas passes through a packed tower with high-surface-area media. A neutralizing solution absorbs VOCs and odorous compounds. A mist eliminator removes droplets, and a pH-controlled recirculation system ensures efficiency.
                </Typography>
                    ...
                    >
                      ...
                      >
                        {[
                          ...
                          { name: 'Foundry Exhaust Scrubber', path: '/wet-scrubbers/foundry-exhaust' },
                        ].map((item, index) => (
                          <ListItem key={index} disableGutters>
                            <MuiLink
     ...
     <ResourcesAndQuote/>
      <CounterSection />
      <WetScrubbersList activeLink="/glue-vapor" />
    </ThemeProvider>
  );
};

export default GlueVaporScrubberPage;