...
import hclScrubberImage from '../assets/images/products/Wet scrubber/HCL-Scrubber-manufacturer.jpg';
...
import productBrochurePdf from '../assets/document/details/baghouse.pdf'; // Update to specific HCL Scrubber PDF when available
...
const HCLScrubberPage = () => {
  ...
  const sections = [
    {
      title: 'Applications',
      details: [
        'Chemical manufacturing for acid fume control.',
        'Pharmaceutical industries for safe gas handling.',
        'Metal pickling to remove corrosive gases.',
        'Waste incineration for emission control.',
        'Chlor-alkali plants for hydrochloric acid scrubbing.',
      ],
    },
    {
      ...
      details: [
        ...
        'PVC materials for chemical compatibility.',
        'Stainless steel for structural durability.',
        'Hastelloy components for high-corrosion environments.',
        'Teflon-lined parts for enhanced chemical resistance.',
      ],
    },
    {
      title: 'Accessories',
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>HCL Scrubber Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Explore NAPCEN's HCL Scrubber, a high-performance wet scrubbing solution designed to neutralize and remove hydrochloric acid fumes, ensuring safety, compliance, and efficiency in industrial applications."
        />
      </Helmet>
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '600px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's HCL Scrubber uses advanced wet scrubbing technology to neutralize hydrochloric acid fumes, ensuring safety, compliance, and a cleaner environment in industrial applications.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
                  ...
                  >
                    {[
                      'High-efficiency HCL removal up to 99%.',
                      'Corrosion-resistant materials for durability.',
                      'Low-maintenance wet scrubbing system.',
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  The HCL Scrubber uses a neutralizing solution in a packed tower to capture and convert hydrochloric acid fumes into harmless compounds, ensuring effective pollutant removal and clean air output.
                </Typography>
                    ...
                    >
                      ...
                      >
                        {[
                          ...
                          { name: 'Ammonia Scrubber', path: '/wet-scrubbers/ammonia' },
                        ].map((item, index) => (
                          <ListItem key={index} disableGutters>
                            <MuiLink
      ...
      <CounterSection />
      <WetScrubbersList activeLink="/hcl" />
    </ThemeProvider>
  );
};

export default HCLScrubberPage;