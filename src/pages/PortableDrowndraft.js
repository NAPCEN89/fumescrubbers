...
import portableDowndraftTableImage from '../assets/images/products/Downdraft tbale/Portable-downdraft -table.jpg';
...
const sections = [
  {
    title: 'Applications',
    details: [
      'Welding operations for fume extraction',
      'Grinding and sanding for dust control',
      'Plasma cutting for smoke and particulate removal',
      'Woodworking for sawdust management',
      'Small-scale industrial tasks requiring mobile dust collection',
    ],
  },
  {
    title: 'Materials of Construction',
    details: [
      'Durable steel frame for structural integrity',
      'High-efficiency filter media for effective dust capture',
      'Corrosion-resistant coatings for longevity',
      'Heavy-duty casters for mobility',
      'Sturdy work surface for versatile applications',
    ],
  },
  {
    title: 'Accessories',
    details: [
      'Multi-stage filtration systems for enhanced performance',
      'Dust collection trays for easy cleanup',
      'Adjustable work surface heights',
      'Optional spark arrestors for welding safety',
      'Customizable filter options for specific particulates',
    ],
  },
  {
    title: 'Technical Details',
    details: [
      'High-efficiency filtration up to 99% for fine particles',
...
const PortableDowndraftTable = () => {
  const [activeTab, setActiveTab] = useState(0);
  const [isAutoCycling, setIsAutoCycling] = useState(true);
  const muiTheme = useTheme();
  const isMobile = useMediaQuery(muiTheme.breakpoints.down('md')); // Mobile breakpoint at 900px

  // Auto-cycle through tabs every 4 seconds
  useEffect(() => {
    let interval;
    if (!isMobile && isAutoCycling) {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Portable Downdraft Table Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Explore NAPCEN's Portable Downdraft Tables, ideal for on-site applications. These tables offer a versatile and efficient solution for capturing fumes, dust, and particulate matter in various industrial settings."
        />
      </Helmet>
      ...
      >
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={portableDowndraftTableImage}
                  alt="Portable Downdraft Table"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '600px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Portable Downdraft Table is a compact, mobile solution designed for efficient dust and fume extraction in industrial and workshop settings, ideal for welding, grinding, and sanding tasks.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
                  ...
                  <ProductDetailsList
                    items={[
                      'Mobility with heavy-duty casters for easy relocation',
                      'Integrated multi-stage filtration for dust and fume capture',
                      'Compact design for space-constrained environments',
                      'Versatile for welding, grinding, sanding, and more',
                      'Enhances operator safety by removing harmful particulates',
                    ]}
                  />
                </CardContent>
              </Card>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  The downdraft table uses a powerful suction system to pull dust and fumes downward through a perforated work surface, capturing contaminants in high-efficiency filters and releasing clean air.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          {/* Services Info Card with Auto-Cycling Titles */}
       ...
       <ResourcesAndQuote/>
      <DowndraftTable activeLink="/portable" />
      <CounterSection />
...
export default PortableDowndraftTable;