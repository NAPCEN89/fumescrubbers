...
import ventGasScrubberImage from '../assets/images/vent-gas-scrubber.jpg';
...
const VentGasScrubberPage = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Vent Gas Scrubber</title>
        <meta
          name="description"
          content="Explore NAPCEN's Vent Gas Scrubber, designed for efficient removal of harmful gases and pollutants in industrial exhaust systems."
        />
      </Helmet>
      ...
      >
        <Container sx={{ px: { xs: 1, sm: 2, md: 3 } }}>
          ...
          >
            ...
            /{' '}
            <RouterLink
              to="/wet-scrubbers/vent-gas-scrubber"
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'400px'}}>
              ...
              >
                <Box
                  component="img"
                  src={ventGasScrubberImage}
                  alt="Vent Gas Scrubber"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'700px'}}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Vent Gas Scrubber removes harmful gases and pollutants, ensuring compliance and safety.
                  </Typography>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  Vent gas is neutralized using absorption and chemical reactions for effective pollutant removal.
                </Typography>
                 <Typography
                    variant="h5"
                    component="h3"
                          ...
                          {activeTab === 2 && (
                            ...
                            >
                              {[
                                ...
                                'Smart liquid control',
                                'Real-time efficiency sensors',
                                'Maintenance alerts',
   ...
   <ResourcesAndQuote/>
      ...
      <WetScrubbersList activeLink="/wet-scrubbers/vent-gas-scrubber" />
      <CounterSection />
...
export default VentGasScrubberPage;