...
import twoStageDustCollectorImage from '../assets/images/products/dust collector/Two-stage-duct-collector-chennai.jpg';
...
const TwoStageDustCollector = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Two Stage Dust Collector</title>
        <meta
          name="description"
          content="Explore high-quality Two Stage Dust Collectors from NAPCEN, designed for efficient dust and particulate removal in various industrial applications."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'400px'}}>
              ...
              >
                <Box
                  component="img"
                  src={twoStageDustCollectorImage}
                  alt="Two Stage Dust Collector"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'700px'}}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Two Stage Dust Collector efficiently removes dust using cyclone and filter stages.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  Contaminated air undergoes cyclone separation followed by high-efficiency filtration for clean exhaust.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  NAPCEN designs advanced dust collectors for efficient particulate removal in industrial settings.
                </Typography>
                <Accordion
                  defaultExpanded
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#e9e9f0ff', p: { xs: 1, sm: 2 } }}>
                    ...
                    >
                      {[
                        ...
                        { name: 'Cyclone Dust Collector', path: '/dust-collectors/cyclone' },
                        ...
                        <ListItem key={index} disableGutters>
                          <MuiLink
                            ...
                            to={item.path}
                            sx={{
                              color: item.path === '/dust-collectors/two-stage' ? '#00BFFF' : 'black',
                              textDecoration: 'none',
                              fontWeight: item.path === '/dust-collectors/two-stage' ? 'bold' : 'normal',
                              '&:hover': { color: '#00BFFF' },
                            }}
                          >
                            <Typography
    ...
    <ResourcesAndQuote/>
      <DustCollectorsList activeLink="/dust-collectors/two-stage" />
      <CounterSection />
...
export default TwoStageDustCollector;