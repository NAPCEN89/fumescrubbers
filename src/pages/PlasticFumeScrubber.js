...
import plasticFumeScrubberImage from '../assets/images/products/Wet scrubber/Plastic-Fume-Scrubber-manufacturer.jpg'; // Updated path
...
const PlasticFumeScrubberPage = () => {
  ...
  const sections = [
    {
      title: 'Applications',
      details: [
        'Plastic manufacturing for VOC and fume control.',
        'Injection molding for emission compliance.',
        'Polymer production for chemical vapor capture.',
        'Recycling facilities for odor and pollutant removal.',
        '3D printing operations for safe air quality.',
        'Extrusion processes for fume neutralization.',
        'Thermoforming for hazardous gas scrubbing.',
      ],
    },
    {
      title: 'Features & Benefits',
      details: [
        'High-efficiency VOC removal (>99%).',
        ...
        'Customizable designs for specific processes.',
    ...
    },
    {
      ...
      details: [
        ...
        'Recirculation system for scrubbing liquid reuse.',
        'Specialized packing media for enhanced contact.',
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Plastic Fume Scrubber Manufacturers in Chennai</title>
        <meta
          name="description"
          content="NAPCEN's Plastic Fume Scrubbers, built with corrosion-resistant materials and advanced pH control, efficiently neutralize VOCs and hazardous fumes, ensuring compliance and safety in plastic manufacturing and related industries."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={plasticFumeScrubberImage}
                  alt="Plastic Fume Scrubber"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '600px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Plastic Fume Scrubbers are advanced air pollution control systems designed to capture and neutralize volatile organic compounds (VOCs) and hazardous fumes generated in plastic manufacturing processes. Built with corrosion-resistant materials and automated pH control, they ensure compliance with environmental regulations and a safe working environment.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
                  ...
                  <ProductDetailsList
                    items={[
                      'High-efficiency VOC and fume removal (>99%).',
                      'Corrosion-resistant materials for durability.',
                      'Automated pH control for consistent performance.',
                      'Low maintenance with easy-access components.',
                    ]}
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  Pollutant-laden fumes from plastic processing enter the scrubber tower, where they pass through high-surface-area packing media. A scrubbing liquid, typically water or a chemical solution like sodium hydroxide, is sprayed counter-currently to absorb and neutralize VOCs and hazardous gases. A mist eliminator removes liquid droplets, and the cleaned gas is released. The scrubbing liquid is recirculated with automated pH control to maintain efficiency.
                </Typography>
                    ...
                    >
                      ...
                      >
                        {[
                          ...
                          { name: 'Packed Bed Wet Scrubber', path: '/wet-scrubbers/packed-bed' },
                        ].map((item, index) => (
                          <ListItem key={index} disableGutters>
                            <MuiLink
      ...
      <ResourcesAndQuote/>
      <CounterSection />
      <WetScrubbersList activeLink="/plastic-fume" />
    </ThemeProvider>
  );
};

export default PlasticFumeScrubberPage;