...
import DowndraftTablesList from '../components/ReusableProducts/DowndraftTable';
import CounterSection from '../components/sections/CounterSection';
import woodworkingDowndraftTableImage from '../assets/images/products/Downdraft tbale/woodworking-downdraft-table.jpg';
...
const WoodWorkingDowndraftTable = () => {
  ...
  const sections = [
    {
      ...
      details: [
        ...
        'Routing and carving',
        'Small-scale cutting and sawing',
        'Assembly and glue-up processes',
    ...
    },
    {
      ...
      details: [
        'High-efficiency dust collection at the source',
        'Multi-stage filtration for fine wood dust',
        'Ergonomic and stable work surface',
        'Low-noise operation for workshop comfort',
        'Customizable table sizes and configurations',
        'Compliance with OSHA safety standards',
        'Reduced risk of dust-related fire hazards',
      ],
    },
    {
      ...
      details: [
        ...
        'Perforated stainless steel tabletop',
        'High-efficiency particulate filters',
        'Durable composite work surfaces',
        'Anti-static components for safety',
      ],
    },
    {
      title: 'Accessories',
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Wood Working Downdraft Table Manufacturers in Chennai</title>
        <meta
          name="description"
          content="NAPCEN's Wood Working Downdraft Tables effectively capture sawdust, wood chips, and fine particulates, ensuring a clean, safe, and efficient woodworking environment."
        />
      </Helmet>
      ...
      >
        <Container sx={{ px: { xs: 1, sm: 2, md: 3 } }}>
          ...
          >
            ...
            /{' '}
            <RouterLink
              to="/downdraft-tables/wood-working"
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={woodworkingDowndraftTableImage}
                  alt="Wood Working Downdraft Table"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '700px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Wood Working Downdraft Table is designed to capture sawdust, wood chips, and fine particulates at the source, ensuring a clean and safe woodworking environment. Its advanced filtration system and ergonomic design make it ideal for carpenters and woodworkers.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  The Wood Working Downdraft Table uses a powerful fan to create negative pressure beneath a perforated tabletop, pulling dust and debris downward. The air passes through a multi-stage filtration system, capturing large chips and fine particulates before releasing clean air back into the workspace.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  NAPCEN: Downdraft Table Experts
                </Typography>
                <Typography
                  variant="body1"
                  paragraph
                ...
                >
                  NAPCEN specializes in designing high-performance Wood Working Downdraft Tables, ensuring effective dust control and a safer workspace for woodworking professionals.
                </Typography>
                <Accordion
                  defaultExpanded
                ...
                >
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#e9e9f0ff', p: { xs: 1, sm: 2 } }}>
                    ...
                    >
                      Our downdraft tables feature multi-stage filtration systems to capture fine wood dust and larger debris, ensuring clean air and a safe workshop.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
                <Accordion sx={{ '&:before': { display: 'none' }, mb: { xs: 1, sm: 2 } }}>
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#e9e9f0ff', p: { xs: 1, sm: 2 } }}>
                    ...
                    >
                      We offer tailored downdraft tables to meet specific workshop needs, optimizing dust capture and workspace efficiency.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
                <Accordion sx={{ '&:before': { display: 'none' } }}>
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#e9e9f0ff', p: { xs: 1, sm: 2 } }}>
                    ...
                    >
                      NAPCEN's downdraft tables are built for continuous operation with minimal maintenance, providing a cost-effective dust control solution.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
              </CardContent>
      ...
      <DowndraftTablesList activeLink="/wood-working" />
      <CounterSection />
...
export default WoodWorkingDowndraftTable;