...
import weldingFumeExtractorImage from '../assets/images/products/Fume extractor/Welding-fume-extractor.jpg';
...
const WeldingFumeExtractor = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      details: [
        'High-efficiency HEPA filtration (99.97% at 0.3 microns)',
        'Activated carbon for gas and odor removal',
        'Adjustable extraction arms for precise fume capture',
        'Low-noise operation for workplace comfort',
        'Compact and portable design',
        'Compliance with OSHA and environmental standards',
        'Low maintenance with filter status indicators',
      ],
    },
    {
      ...
      details: [
        ...
        'Heat-resistant flexible extraction arms',
      ],
    },
    {
      title: 'Accessories',
      details: [
        ...
        'Spark arrestors for fire safety',
        'Portable base with wheels',
        'Remote control systems',
        'Filter cleaning systems for extended life',
      ],
    },
  ];
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Welding Fume Extractor Manufacturers in Chennai</title>
        <meta
          name="description"
          content="NAPCEN's Welding Fume Extractors, equipped with HEPA and activated carbon filtration, efficiently capture hazardous welding fumes, ensuring worker safety and compliance with environmental standards."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={weldingFumeExtractorImage}
                  alt="Welding Fume Extractor"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '700px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Welding Fume Extractor is a high-performance air filtration system designed to capture and eliminate hazardous fumes and particulates generated during welding processes. Using advanced HEPA and activated carbon filtration, it ensures a safer work environment and compliance with occupational safety standards.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  The Welding Fume Extractor operates by drawing contaminated air through a flexible extraction arm positioned near the welding source. The air passes through multi-stage filtration, including HEPA filters for ultrafine particulates and activated carbon filters for gases and odors, before clean air is released back into the workspace.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  NAPCEN specializes in high-efficiency Welding Fume Extractors, designed to ensure superior air quality and worker safety in industrial environments.
                </Typography>
                <Accordion
                  defaultExpanded
                ...
                >
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#e9e9f0ff', p: { xs: 1, sm: 2 } }}>
                    ...
                    >
                      Our engineers utilize HEPA and activated carbon filters to capture ultrafine particulates and harmful gases, ensuring clean air in welding environments.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
                <Accordion sx={{ '&:before': { display: 'none' }, mb: { xs: 1, sm: 2 } }}>
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#e9e9f0ff', p: { xs: 1, sm: 2 } }}>
                    ...
                    >
                      We provide tailored fume extractors to meet specific facility needs, optimizing fume capture and workplace safety.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
                <Accordion sx={{ '&:before': { display: 'none' } }}>
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#e9e9f0ff', p: { xs: 1, sm: 2 } }}>
                    ...
                    >
                      NAPCEN's extractors are designed for continuous operation with minimal maintenance, offering a cost-effective solution for air purification.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
              </CardContent>
     ...
     <ResourcesAndQuote/>
      ...
      <FumeExtractor activeLink="/welding" />
      <CounterSection />
...
export default WeldingFumeExtractor;