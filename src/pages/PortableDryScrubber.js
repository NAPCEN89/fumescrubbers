...
import portableDryScrubberImage from '../assets/images/resource/all type of dry scrubber/21.jpg';
...
const sections = [
  {
    title: 'Applications',
    details: [
      'Construction sites for dust and gas control',
      'Maintenance operations in confined spaces',
      'Laboratories for chemical fume extraction',
      'Emergency response for hazardous material cleanup',
      'Temporary setups in industrial environments',
    ],
  },
  {
    ...
    details: [
      ...
      'Activated carbon for effective gas absorption',
      'HEPA filters for fine particulate capture',
  ...
  },
  {
    ...
    details: [
      ...
      'Custom filter media for specific pollutants',
      'Portable power supply for field use',
      'Wheeled base for easy mobility',
      'Sound-dampening enclosures for noise reduction',
    ],
  },
  {
    title: 'Technical Details',
    details: [
      'Airflow capacity of 100-5,000 CFM',
      'High-efficiency filtration up to 99.97% for fine particles',
      'Replaceable filters for cost-effective maintenance',
...
const PortableDryScrubber = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Portable Dry Scrubber Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Discover NAPCEN's Portable Dry Scrubber, a compact and mobile solution for removing harmful gases and particulates, ideal for flexible and temporary air pollution control needs."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '400px' }}>
              ...
              >
                <Box
                  component="img"
                  src={portableDryScrubberImage}
                  alt="Portable Dry Scrubber"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{ maxWidth: '600px' }}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's Portable Dry Scrubber is a compact, mobile solution designed for efficient removal of harmful gases and particulates, ideal for flexible and temporary air pollution control in various industrial settings.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
                  ...
                  <ProductDetailsList
                    items={[
                      'Mobile design with wheeled base for easy relocation',
                      'Advanced filtration with HEPA and activated carbon',
                      'Plug-and-play setup for quick deployment',
                      'Low maintenance with replaceable filters',
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  The Portable Dry Scrubber uses a combination of filtration and adsorption processes, where pollutants are captured by dry media such as activated carbon and HEPA filters, ensuring clean air output and safe operation.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
      ...
      <ResourcesAndQuote/>
      <DryScrubber activeLink="/portable" />
      <CounterSection />
...
export default PortableDryScrubber;