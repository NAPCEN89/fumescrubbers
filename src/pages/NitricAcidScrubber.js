...
import nitricAcidScrubberImage from '../assets/images/products/Wet scrubber/Nitric-Acid-Scrubber-manufacturer.jpg'; // Placeholder path
...
const NitricAcidScrubberPage = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Helmet>
        <title>Nitric Acid Scrubber Manufacturers in Chennai</title>
        <meta
          name="description"
          content="Discover NAPCEN's Nitric Acid Scrubber, an advanced air pollution control device designed to neutralize and capture nitric acid fumes, ensuring a safe and compliant environment."
        />
      </Helmet>
          ...
          <Grid container item xs={12} spacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="center">
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'400px'}}>
              ...
              >
                <Box
                  component="img"
                  src={nitricAcidScrubberImage}
                  alt="Nitric Acid Scrubber"
                  sx={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <Grid item xs={12} md={6} sx={{maxWidth:'700px'}}>
              ...
              >
                <CardContent sx={{ p: 0, overflowY: 'auto' }}>
                  ...
                  >
                    NAPCEN's nitric acid scrubber neutralizes HNO₃ fumes, ensuring environmental compliance.
                  </Typography>
                  <Typography
                    variant="h5"
                    component="h3"
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                >
                  Fumes are neutralized using a wet scrubbing process with sodium hydroxide.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
     ...
     <ResourcesAndQuote/>
      <WetScrubbersList activeLink="/wet-scrubbers/nitric-acid" />
      <CounterSection />
...
export default NitricAcidScrubberPage;