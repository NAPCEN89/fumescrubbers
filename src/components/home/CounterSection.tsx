...
export default function AnimatedCounters() {
  const counters = [
    { end: 13, title: 'Years of Expertise', symbol: '+', imageSrc: yearsIcon },
    { end: 98, title: 'Client Success', symbol: '%', imageSrc: satisfactionIcon },
    { end: 150, title: 'Systems Active', symbol: '+', imageSrc: systemsIcon },
    { end: 500, title: 'Projects Done', symbol: '+', imageSrc: projectsIcon },
  ];

  return (
    <section className="bg-gradient-to-l from-[#334746ff] to-[#151d1dff] py-12 border-y border-white/5">
      <div className="max-w-7xl mx-auto px-4">
        
        {/* Semantic SEO (Hidden from view) */}
