...
const PARTNER_LOGOS = [PartnerLogo1, PartnerLogo2, PartnerLogo3, PartnerLogo4, PartnerLogo5];
...
export default function PartnerSection() {
  // Memoize the doubled array for the infinite scroll to prevent re-renders
  const infiniteLogos = useMemo(() => [...PARTNER_LOGOS, ...PARTNER_LOGOS, ...PARTNER_LOGOS], []);

  return (
    <section className="py-20 bg-gradient-to-l from-[#334746ff] to-[#151d1dff] overflow-hidden font-poppins text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-10">
            <h1 className="font-black leading-none text-8xl md:text-[9rem] text-cyan-400 opacity-90">
        ...
        {/* --- LOGO MARQUEE (High Performance CSS Animation) --- */}
        <div className="relative mb-24">
          <div className="absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-[#151d1dff] to-transparent z-10" />
          <div className="absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-[#334746ff] to-transparent z-10" />
