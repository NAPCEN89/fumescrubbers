...
const DARK_BG = '#0A1F22'; // Your existing dark teal
  ...
  return (
    <ThemeProvider theme={theme}>
      <Box sx={{ bgcolor: DARK_BG, minHeight: '100vh', color: 'white', pb: 10 }}>
        ...
        {/* 4. PREMIUM RESOURCES & QUOTE SECTION (YOUR REQUESTED UI) */}
        ...
        <Modal open={openQuote} onClose={() => setOpenQuote(false)}>
          <Box sx={MODAL_STYLE}>
            <Typography variant="h4" color={ACCENT_GREEN} textAlign="center" fontWeight={900} mb={4}>Request Quote</Typography>
            ...
            <TextField label="Brief Requirement" fullWidth multiline rows={4} sx={{ mb: 3 }} />
            <Button fullWidth variant="contained" size="large" sx={{ py: 2, fontWeight: 700, bgcolor: ACCENT_GREEN }}>Submit for Pricing</Button>
          </Box>
        </Modal>
