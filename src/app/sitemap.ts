export const dynamic = 'force-static'; // <--- THIS LINE IS REQUIRED

import { MetadataRoute } from 'next';
import { productData } from '@/lib/products-data';

export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://www.napcen.com';

  // 1. Generate URLs for Category Pages
  ...
  // 2. Generate URLs for every individual Product
